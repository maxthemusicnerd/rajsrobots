...
function changeDuration() {
    let duration_message = document.getElementById("duration-text")
    duration_message = prompt("Please enter desired duration")
    duration = duration_message
    document.getElementById("duration-text").innerHTML = duration_message
    recalculate()
}
